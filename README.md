...
--------------------------------------------------------------------->
## 📝 Sobre
O design do projeto Bikcraft foi criado utilizando a ferramenta Figma, durante o curso de UI/UI Design, e então, foi desenvolvido durante o curso de HTML e CSS, assim, colocando em prática todo o conhecimento adquirido durante ambos os cursos.
